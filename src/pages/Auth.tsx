  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm space-y-6">
        <div className="text-center">
          <Shirt className="h-10 w-10 text-accent mx-auto mb-3" />
          <h1 className="font-display text-2xl font-semibold">Wardrobé</h1>
          <p className="text-sm text-muted-foreground mt-1">
            {isLogin ? "Sign in to your wardrobe" : "Create your wardrobe account"}
          </p>
        </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          {!isLogin && (
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" value={fullName} onChange={(e) => setFullName(e.target.value)} className="pl-9" placeholder="Your name" required />
              </div>
            </div>
          )}
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              {isLogin && <button type="button" onClick={() => setShowForgot(true)} className="text-xs text-accent hover:underline">Forgot?</button>}
            </div>
            <div className="relative">
